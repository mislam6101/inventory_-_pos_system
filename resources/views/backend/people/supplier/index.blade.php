                            ...
                            <table id="selection-datatable"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$sup->email}}</td>
                                        <td>{{$sup->address}}</td>
                                        <td>{{$sup->updated_at->format('d M Y')}}</td>
                                        <td><a href="{{route('supplier.edit', $sup->id)}}"><i class="fa fa-edit" style="font-size:20px;"></i></a>&nbsp&nbsp | &nbsp&nbsp

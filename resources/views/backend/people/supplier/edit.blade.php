                                ...
                                <div class="col-lg-6">
                                    <form method="POST" action="{{route('supplier.update', $supplier->id)}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control" value="{{ old('supp_name', $supplier->name) }}" name="supp_name">
                                        </div>
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Contact Number</label>
                                            <input type="text" id="simpleinput" class="form-control" value="{{ old('contact', $supplier->contact) }}" name="contact">
                                        </div>
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">email</label>
                                            <input type="email" value="{{ old('email', $supplier->email) }}" id="simpleinput" class="form-control" name="email" placeholder="name@email.com">
                                        </div>
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Supplier Address</label>
                                            <input type="text" value="{{ old('address', $supplier->address) }}" id="simpleinput" class="form-control" name="address">
                                        </div>

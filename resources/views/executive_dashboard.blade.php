...
<head>
    <meta charset="utf-8" />
    <title>Layout Lite Sidebar | Velonic - Bootstrap 5 Admin & Dashboard Template</title>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{url('')}}/javascript: void(0);">Velonic</a></li>
                                        <li class="breadcrumb-item"><a href="{{url('')}}/javascript: void(0);">Layout</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-widgets">
                                        <a href="{{url('')}}/javascript:;" data-bs-toggle="reload"><i
                                                class="ri-refresh-line"></i></a>
                                        <a data-bs-toggle="collapse" href="{{url('')}}/#weeklysales-collapse" role="button"
                                            aria-expanded="false" aria-controls="weeklysales-collapse"><i
                                                class="ri-subtract-line"></i></a>
                                        <a href="{{url('')}}/#" data-bs-toggle="remove"><i class="ri-close-line"></i></a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-widgets">
                                        <a href="{{url('')}}/javascript:;" data-bs-toggle="reload"><i
                                                class="ri-refresh-line"></i></a>
                                        <a data-bs-toggle="collapse" href="{{url('')}}/#yearly-sales-collapse" role="button"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 text-center">
                            <script>document.write(new Date().getFullYear())</script> © by <b>Md. Mahmudul Islam</b>
                        </div>
                    </div>
                </div>
            </footer>
